    ...
    <tbody>
        ...
        @if(count($serviceDataArr) > 0)
            ...
            @foreach($serviceDataArr as $singleRec)
                ...
                @php 
                    $service_detail_Url = $singleRec->servicedetail_pic ? url('/').'/'.$singleRec->servicedetail_pic : ''; 
                @endphp
                <tr>
                    ...
                    <td scope="row" class="text-center">
                        @if($service_detail_Url)<img src="{{ $service_detail_Url }}" style="width: 25px; height: 25px;" />@else - @endif
                    </td>

                    <td scope="row" class="text-center">{{ $singleRec->service_detail_title }}</td>

                    <td scope="row" class="text-center">

                        <div class="d-flex justify-content-center">

                            <div class="service-detail-edit" style="cursor: pointer;" data-service-detail="{{ $singleRec }}">

                                <i class="icon-copy fa fa-edit m-2" aria-hidden="true"></i>

                            </div>

                            <div class="service-detail-delete" style="cursor: pointer;" data-id="{{ $singleRec->id }}"><i class="icon-copy fa fa-trash m-2" aria-hidden="true"></i></div>
                ...
                <tr>
                    ...
                    <td colspan="10" scope="row" class="text-center">
                        ...
                        <div class="d-flex">
                            ...
                            @foreach($singleRec->serviceDetailImages as $simg)
