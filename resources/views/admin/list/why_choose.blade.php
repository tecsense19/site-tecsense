    ...
    <tbody>
                ...
                <tr>
                    ...
                    <td scope="row" class="text-center">
                        <div class="d-flex justify-content-center">
                            <div class="why-choose-edit" style="cursor: pointer;" data-whychoose="{{ $singleRec }}">
                                <i class="icon-copy fa fa-edit m-2" aria-hidden="true"></i>
                            </div>
                            <div class="why-choose-delete" style="cursor: pointer;" data-id="{{ $singleRec->id }}"><i class="icon-copy fa fa-trash m-2" aria-hidden="true"></i></div>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td colspan="10" scope="row" class="text-center">
                        <div class="d-flex">
                            @foreach($singleRec->whyChooseImages as $simg)
        ...
        @else
            <tr scope="row" style="text-align: center;">
                <td colspan="5">Why Choose List Not Found.</td>
            </tr>
        @endif
    </tbody>
</table>
{!! $whyChooseDataArr->links('pagination') !!}