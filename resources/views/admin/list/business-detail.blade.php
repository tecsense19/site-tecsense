        ...
        @if(count($serviceDataArr) > 0)
            ...
            @foreach($serviceDataArr as $singleRec)
                <tr>
                    ...
                    <td scope="row" class="text-center">{{ $singleRec->business_description }}</td>

                    <td scope="row" class="text-center">

                        <div class="d-flex justify-content-center">

                            <div class="business-detail-edit" style="cursor: pointer;" data-business-detail="{{ $singleRec }}">

                                <i class="icon-copy fa fa-edit m-2" aria-hidden="true"></i>

                            </div>

                            <div class="business-detail-delete" style="cursor: pointer;" data-id="{{ $singleRec->id }}"><i class="icon-copy fa fa-trash m-2" aria-hidden="true"></i></div>
                ...
                <tr>
                    ...
                    <td colspan="10" scope="row" class="text-center">
                        ...
                        <div class="d-flex">
                            ...
                            @foreach($singleRec->businessDetailImages as $simg)
