                ...
                <tr>
                    ...
                    <td scope="row" class="text-center">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <div class="best-result-detia-edit" style="cursor: pointer;" data-best-result-detail="{{ $singleRec }}">

                                <i class="icon-copy fa fa-edit m-2" aria-hidden="true"></i>

                            </div>

                            <div class="best-result-detail-delete" style="cursor: pointer;" data-id="{{ $singleRec->id }}"><i class="icon-copy fa fa-trash m-2" aria-hidden="true"></i></div>
                ...
                <tr>
                    ...
                    <td colspan="10" scope="row" class="text-center">
                        ...
                        <div class="d-flex">
                            ...
                            @foreach($singleRec->bestResultDetailImages as $simg)
