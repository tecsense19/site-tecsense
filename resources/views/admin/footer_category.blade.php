...
<div class="pd-20 card-box mb-30">
    ...
    <form method="POST" action="{{ route('admin.footer.category.store') }}" enctype="multipart/form-data" name="footer_category_model_form" id="footer_category_model_form">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <div class="form-group">
                <input type="text" class="form-control" name="search_footer_category" id="search_footer_category" placeholder="Search Footer Category" />
            </div>
        </div>
    </div>
    <div class="table-responsive footerCategoryDataList">
        
    </div>
</div>
<script src="https://code.jquery.com/jquery-3.7.1.min.js"></script>
<script src="{{ URL::asset('public/js/footer_category.js') }}"></script>
