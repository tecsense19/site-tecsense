...
<body class="login-page">
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-md-6 col-lg-7">
					<img src="{{ URL::asset('public/vendors/images/login-page-img.png') }}" alt="">
				</div>
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-primary">Login To Tec-Sense</h2>
						</div>
							...
							<div class="select-role">
								<div class="btn-group btn-group-toggle" data-toggle="buttons">
									<label class="btn active">
										...
										<div class="icon"><img src="{{ URL::asset('public/vendors/images/briefcase.svg') }}" class="svg" alt=""></div>
										<span>I'm</span>
										Manager
									</label>
									<label class="btn">
										<input type="radio" name="options" id="user">
										<div class="icon"><img src="{{ URL::asset('public/vendors/images/person.svg') }}" class="svg" alt=""></div>
										<span>I'm</span>
										Employee
									</label>
								</div>
	...
	<!-- js -->
	<script src="{{ URL::asset('public/vendors/scripts/core.js') }}"></script>
	<script src="{{ URL::asset('public/vendors/scripts/script.min.js') }}"></script>
	<script src="{{ URL::asset('public/vendors/scripts/process.js') }}"></script>
	<script src="{{ URL::asset('public/vendors/scripts/layout-settings.js') }}"></script>
</body>
</html>